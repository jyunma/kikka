      ...
      <div class="col-lg-8 col-md-10 mx-auto">
        <div class="post-preview">
            <h2 class="post-title" style="font-family: 'BBTreeGL'; font-weight: bold;">
             ${user.user_name} 님의 정보 수정
            </h2>
            <br><br>
            <form role="form" action="update" method="post" class="post-subtitle" style="font-family: 'Noto Sans KR', sans-serif; font-size: 85%; font-weight: bold;">
                    <input type="hidden" name="user_id" value="${user.user_id}"> 
                    <div class="form-group">
                        <label for="InputEmail">EMAIL</label>
                        <input type="email" class="form-control" id="InputEmail" placeholder="이메일 주소를 입력해주세요" name="user_email" value="${user.user_email}">
                    </div>
                    <div class="form-group">
                        <label for="inputMobile">PHONE</label>
                        <input type="tel" class="form-control" id="inputMobile" placeholder="휴대폰번호를 입력해 주세요" name="user_phone" value="${user.user_phone}">
                    </div>
                    <div class="form-group">
                        <label for="InputName">POSTAL CODE</label><br>
                        <input type="button"  id="postal_btn"class="btn btn-light" onclick="sample6_execDaumPostcode()" value="우편번호 찾기"><br><br>
                        <input type="text" id="sample6_postcode" class="form-control" placeholder="우편번호" name="user_postal_code" value="${user.user_postal_code}">
                    </div>
                    <div class="form-group">
                        <label for="InputName">ADDRESS</label>
                        <input type="text" class="form-control" id="sample6_address" placeholder="주소" name="user_new_address" value="${user.user_new_address}"><br>
